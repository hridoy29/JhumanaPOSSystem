    ...
    public class DbProviderHelper
    {
        ...
        public static DbConnection GetConnection()
        {
            if (dbConnection == null || string.IsNullOrEmpty(dbConnection.ConnectionString))
            {
                ...
                dbConnection.ConnectionString = connectionStringsSection.ConnectionStrings["dbCon"].ConnectionString;
            }
            return dbConnection;
        }
        ...
        public static DbCommand CreateCommand(String commandText, CommandType commandType, int timeOutPeriod)
        {
            DbCommand dbCommand = dbProviderFactory.CreateCommand();
            dbCommand.Connection = dbConnection;
            dbCommand.CommandType = commandType;
            dbCommand.CommandText = commandText;
            dbCommand.CommandTimeout = timeOutPeriod;
        ...
        public static DbCommand CreateCommand(String commandText, CommandType commandType, DbTransaction dbTransaction, int timeOutPeriod)
        {
            DbCommand dbCommand = dbProviderFactory.CreateCommand();
            dbCommand.Connection = dbConnection;
            dbCommand.CommandType = commandType;
